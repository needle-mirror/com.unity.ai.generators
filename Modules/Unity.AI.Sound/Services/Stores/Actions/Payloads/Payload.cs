...
namespace Unity.AI.Sound.Services.Stores.Actions.Payloads
{
    ...
    record GenerationValidationSettings(AssetReference asset, bool prompt, bool negativePrompt, string model, int roundedFrameDuration, int variations, int referenceCount) : AsssetContext(asset);
