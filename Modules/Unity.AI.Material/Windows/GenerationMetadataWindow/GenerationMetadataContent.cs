...
namespace Unity.AI.Material.Windows.GenerationMetadataWindow
{
    class GenerationMetadataContent : VisualElement
    {
        public event Action OnDismissRequested;

        const string k_Uxml = "Packages/com.unity.ai.generators/modules/Unity.AI.Material/Windows/GenerationMetadataWindow/GenerationMetadataWindow.uxml";
