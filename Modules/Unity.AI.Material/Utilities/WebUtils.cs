...
namespace Unity.AI.Material.Services.Utilities
{
    static class WebUtils
    {
        ...
        const string k_SetEnvironmentMenu = "AI Toolkit/Internals/AI.Material/Set Environment";
        const string k_SelectedEnvironmentKey = "AI_Toolkit_Material_Environment";
