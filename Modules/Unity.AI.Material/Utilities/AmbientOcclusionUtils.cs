...
namespace Unity.AI.Material.Services.Utilities
{
    static class AmbientOcclusionUtils
    {
        ...
        {
            if (!s_ComputeShader)
                s_ComputeShader = AssetDatabase.LoadAssetAtPath<ComputeShader>("Packages/com.unity.ai.generators/modules/Unity.AI.Material/Shaders/AmbientOcclusionScale.compute");
            ...
            if (!s_FragmentShader)
                s_FragmentShader = AssetDatabase.LoadAssetAtPath<Shader>("Packages/com.unity.ai.generators/modules/Unity.AI.Material/Shaders/AmbientOcclusion.shader");
